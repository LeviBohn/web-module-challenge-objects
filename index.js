...
*/
console.log('task 1b:', createMenuItem('pizza', 4, 'Lunch'));
console.log('task 1b:', createMenuItem('nachos', 3, 'Snacks'));
console.log('task 1b:', createMenuItem('ice cream', 5, 'Desserts'));
